...
class RAGPipeline:
    ...
    def query_documents(self, query: str) -> Dict[str, Any]:
        ...
        results = self.embedder.hybrid_search_v1(query, top_k=self.k)
        final_answer = self.embedder.generate_answer_with_citations(self.llm, results["query"], results["top_k_docs"])
